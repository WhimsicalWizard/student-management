...
$sql = "Insert into students (first_name,last_name,e_mail, phone,city,address,dob, update_at) values('$firstname','$lastname','$email','$phone','$city','$address','$dob', '$time')";
...
<body>
  ...
  <div class="container">
     ...
     <form name="Register" action="student_edit.php" method="post" onsubmit="return validateForm()">
